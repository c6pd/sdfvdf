local Tables = {
 ...
 if not isfile("verse.solutions") then
    makefolder("verse.solutions")
 end
                         ...
                         function library:addTab(name,image)
                            ...
                            function contains(list, x)
                               for _, v in pairs(list) do
                                  ...
                                  writefile("verse.solutions/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                               ...
                               function library:deleteConfig()
                                  ...
                                  function library:refreshConfigs()
                                     local tbl = {}
                                     for i,v in next, listfiles("verse.solutions") do table.insert(tbl,v) end
